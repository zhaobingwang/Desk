$(function () {
    ...
    var dataTable = $('#AuthorsTable').DataTable(
        abp.libs.datatables.normalizeConfiguration({
            ...
            searching: false,
            scrollX: true,
            ajax: abp.libs.datatables.createAjax(desk.gist.aBPDemo.authors.author.getList),
            columnDefs: [
                {
                    title: l('Actions'),
                    rowAction: {
                            ...
                            [
                                {
                                    text: l('Edit'),
                                    visible:
                                        abp.auth.isGranted('ABPDemo.Authors.Edit'),
                                ...
                                },
                                {
                                    text: l('Delete'),
                                    visible:
                                        abp.auth.isGranted('ABPDemo.Authors.Delete'),
