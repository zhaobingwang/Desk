...
using Desk.Gist.ABPDemo.Web.Menus;
    ...
    public class ABPDemoWebModule : AbpModule
    {
        ...
        private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
        {
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                {
                    options.FileSets.ReplaceEmbeddedByPhysical<ABPDemoDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Desk.Gist.ABPDemo.Domain.Shared"));
                    options.FileSets.ReplaceEmbeddedByPhysical<ABPDemoDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Desk.Gist.ABPDemo.Domain"));
                    options.FileSets.ReplaceEmbeddedByPhysical<ABPDemoApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Desk.Gist.ABPDemo.Application.Contracts"));
                    options.FileSets.ReplaceEmbeddedByPhysical<ABPDemoApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}Desk.Gist.ABPDemo.Application"));
